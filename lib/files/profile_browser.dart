      ...
      return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Text('صفحة شخصية',style: TextStyle(fontSize: 16),),
          ),
        ),
        body: StreamBuilder<Model>(
                      ...
                      Stack(
                        ...
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            Text('يعمل', style: TextStyle(fontSize: 14,color: Colors.deepOrangeAccent),
                            ),
                          ),
                          Positioned(
                            bottom: 10,
                            ...
                            child: Container(
                              ...
                              child: RawMaterialButton(
                                ...
                                child: Text('تعليقات' , style: TextStyle(fontSize: 14,color: Colors.white),textDirection: TextDirection.rtl,),
                              ),
                            ),
                          ),
                          Positioned(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text('تقييم' , style: TextStyle(fontSize: 14,color: Colors.white),textDirection: TextDirection.rtl,),
                                    ),
                                  ],
                                ),
                              ),
