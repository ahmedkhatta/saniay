...
Future loginWithPhone (String phone ) async{
  ...
  _auth.verifyPhoneNumber(
    ...
    verificationCompleted: (AuthCredential authCred ) async {
      ...
      if (result.user != null ) Navigator.pop(context);
      },
    ...
    verificationFailed: (AuthException authException ){
      ...
      if (authException.code == 'invalidCredential'){
        setState( ()  {
          ...
          errorDetails = 'رقم الهاتف غير صحيح';
          loading =false;
        });
      }
    },
      ...
      showModal(
        ...
        builder: (context){
          return AlertDialog(
            ...
            title: Center(child: Text('ستصلك رسالة التحقق')),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        RaisedButton(
                          ...
                          child: Text("ألغاء", style: TextStyle(fontSize: 14, color: Colors.white),),
                        ),
                        RaisedButton(
                          color: kActiveBtnColor,
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),
                          child: Text("تحقق", style: TextStyle(fontSize: 14, color: Colors.white),),
                          onPressed: () async {
                            setState(()  {
                              loading = true;
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              ...
              firebasePhoneFormatError == false ? SizedBox():Text('رقم الهاتف غير صحيح',style: TextStyle(color: Colors.red),),
              FadeY(
                duration: Duration(milliseconds: 200),
                delay: 0.4,
                child: AnimatedContainer(
                  ...
                  child: RaisedButton(
                    ...
                    child: Center(
                      child:loading == false ?
                      Text("تسجيل", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white),) :
                      AnimatedContainer(
                        duration: Duration(milliseconds: 250),
                  ...
                  builder: (BuildContext context, StateSetter setState){
                    return Column(
                      ...
                      children: <Widget>[
                        ...
                        invalidToken == true ? Text('تأكد من الرمز') : SizedBox(),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget>[
            ...
            child: Column(
              children: <Widget>[
                      ...
                      child: DropdownButton<String>(
                        items: jopList.map((JopShopTile jop) {
                          return DropdownMenuItem<String>(
                            value: jop.name,
                            child: Center(child: Text(jop.name, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold,fontSize: 13),),),
                          );
                        }).toList(),
                        ...
                        hint: Center(child: _jop == null ? Text(
                            'المهنة', style: TextStyle(color: Colors.grey)) : Text(
                ...
                jopValidationError == false ? SizedBox() : Text(
                  'اختر المهنة', style: TextStyle(color: Colors.red),),
                AnimatedContainer(
                  width: 120,
                  height: 35,
                  duration: Duration(milliseconds: 250),
                  child: RaisedButton(
                    onPressed: () async {
                      ...
                      if (nameValidationError == false &&
                          phoneValidationError == false && _jop != null) {
                        _formKey.currentState.save();
                        loading = true;
                        Future.delayed(Duration(seconds: 3)).then((value) {setState(() {loading = false ;});});
                        signupWithPhone(_phone);
                    ...
                    child: loading == false
                        ? Text("تسجيل", style: TextStyle(fontSize: 15,
          ...
          return FadeY(
            ...
            child: Column(
              children: <Widget>[
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        items: shopsList.map((JopShopTile shop) {
                          return DropdownMenuItem<String>(
                            value: shop.name,
                            child: Center(child: Text(shop.name, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold,fontSize: 13),),),
                          );
                        }).toList(),
                        ...
                        hint: Center(child: _selectedShop == null
                            ?Text('المحل',style: TextStyle(color: Colors.grey))
                ...
                shopValidationError == false ? SizedBox():Text('اختر المحل',style: TextStyle(color: Colors.red),),
                AnimatedContainer(
                  duration: Duration(milliseconds: 250),
                  width: 120,
                  height: 35,
    ...
    return Expanded(  
      child: SingleChildScrollView(
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              firebaseNetError == false ?SizedBox(height: 10) :Text('تاكد من اتصالك',style: TextStyle(color: Colors.red),),
              FadeY(
                duration: Duration(milliseconds: 200),
                delay: 0.0,
                child: AnimatedContainer(
              ...
              nameValidationError == false ? SizedBox():Text('ادخل الاسم',style: TextStyle(color: Colors.red),),
              FadeY(
                duration: Duration(milliseconds: 200),
                delay: 0.2,
                child: Container(
              ...
              phoneValidationError == false ? SizedBox():Text('ادخل رقم الهاتف',style: TextStyle(color: Colors.red),),
              firebasePhoneFormatError == false ?SizedBox() :Text('تاكد من رقم الهاتف',style: TextStyle(color: Colors.red),),
              FadeY(
                duration: Duration(milliseconds: 200),
                delay: 0.4,
                child: AnimatedContainer(
                  ...
                  child: Center(
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        items: <String>['عميل', 'صنايعي', 'محلات',].map((String accountType) {
                          return DropdownMenuItem<String>(
                            value: accountType,
                        ...
                        hint: Center(child: _accountTypeSelected == null
                            ?Text('نوع الحساب',style: TextStyle(color: Colors.grey))
