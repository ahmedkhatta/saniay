...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final userState = Provider.of<FirebaseUser>(context, listen: false);
    ...
    showModal(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Column(
          children: <Widget>[
            Text('اطلب من العميل تحديد تقييم صنايعي', style: TextStyle(fontSize: 15)),
            Text('و تصوير الكود الخاص بك', style: TextStyle(fontSize: 15)),
          ],
        ),
    ...
    return showModalBottomSheet(
      ...
      builder: (context) => Container(
          ...
          child: Column(
                ...
                children: <Widget>[
                  Text('تغيير الصورة الشخصية', style: TextStyle(fontSize: 16)),
                  SizedBox(height: 20),
                  GestureDetector(
                    onTap: () async {
                    ...
                    children: <Widget>[
                      ...
                      FadeX(
                        ...
                        child: CustomTextField(
                          containerWidth: screenSize.width,
                          style: TextStyle(fontSize: 16),
                          initialValue: snapshot.data.phone2 ?? 'اصف هاتف جديد ' ,
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    SizedBox(),
                                    Text('${snapshot.data.type}', style: TextStyle(fontSize: 14)),
                              ...
                              child: AnimatedContainer(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(width: 50,),
                                    Text( newStatus ?? snapshot.data.isAvailable ? 'متفرغ' : 'يعمل', style: TextStyle(fontSize: 16)),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                SizedBox(width: 50),
                                Text('اضف صور لشغلك',style: TextStyle(fontSize: 14),),
                                IconButton(
